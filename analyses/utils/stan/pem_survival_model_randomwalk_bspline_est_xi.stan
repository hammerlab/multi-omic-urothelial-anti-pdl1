...
data {
  ...
  vector<lower=0>[H] xi;          // prior for knot positions
...
parameters {
  ...
  vector[H] est_xi_raw;             // knot positions (estimate)
}
transformed parameters {
  ...
  positive_ordered[H] est_xi;
  
  est_xi <- xi + est_xi_raw;
